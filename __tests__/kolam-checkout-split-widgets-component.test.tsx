...
import {KolamCheckoutSummaryPanel} from '../src/components/kolam-checkout-summary-panel';
import {KolamCheckoutWorkspace} from '../src/components/kolam-checkout-workspace-main';
import {KolamSellableCatalogPicker} from '../src/components/kolam-sellable-catalog-picker';
...
describe('checkout split widgets', () => {
  it('renders direct imports for checkout workspace, picker, and summary', async () => {
