...
import {KolamAttentionPanel} from '../src/components/kolam-attention-panel';
import {KolamCommandPaletteOverlay} from '../src/components/kolam-command-palette-overlay';
import {KolamUserMenuPanel} from '../src/components/kolam-user-menu-panel';
...
describe('overlay split widgets', () => {
  it('renders direct imports for attention, user menu, and command palette', async () => {
