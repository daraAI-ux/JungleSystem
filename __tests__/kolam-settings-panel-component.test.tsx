  ...
  it('renders financial settings shell sections in FE order', async () => {
    ...
    expect(text).toEqual(
      expect.arrayContaining([
        ...
        'Metode pembayaran',
        'Channel pembayaran yang diterima toko dan wallet terkait.',
        'Metode nonaktif',
        'Profil pajak perusahaan',
        'NPWP, status PKP, alamat, dan data wajib pajak untuk Tax Intelligence.',
        'Harga jual include PPN',
        'PPh 21 komisi',
        'Lembur karyawan',
        'Per jam atau per hari untuk pengajuan lembur karyawan.',
