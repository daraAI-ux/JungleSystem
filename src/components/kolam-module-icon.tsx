...
import {KOLAM_TRANSFER_AM_ICON_SVG} from '../assets/icons/transfer-am-icon-svg';
...
const AUTOMATION_ICON_PATHS = [
  'M12 2.75C12.69 2.75 13.25 3.31 13.25 4V5.14C16.77 5.72 19.5 8.78 19.5 12.45V16.05C19.5 18.61 17.41 20.7 14.85 20.7H9.15C6.59 20.7 4.5 18.61 4.5 16.05V12.45C4.5 8.78 7.23 5.72 10.75 5.14V4C10.75 3.31 11.31 2.75 12 2.75ZM9.15 7.5C6.92 7.5 5.1 9.32 5.1 11.55V16.05C5.1 17.8 6.52 19.22 8.27 19.22H15.73C17.48 19.22 18.9 17.8 18.9 16.05V11.55C18.9 9.32 17.08 7.5 14.85 7.5H9.15ZM8.7 11.35C9.39 11.35 9.95 11.91 9.95 12.6C9.95 13.29 9.39 13.85 8.7 13.85C8.01 13.85 7.45 13.29 7.45 12.6C7.45 11.91 8.01 11.35 8.7 11.35ZM15.3 11.35C15.99 11.35 16.55 11.91 16.55 12.6C16.55 13.29 15.99 13.85 15.3 13.85C14.61 13.85 14.05 13.29 14.05 12.6C14.05 11.91 14.61 11.35 15.3 11.35ZM9 16.2H15V17.55H9V16.2Z',
] as const;
const HOME_ICON_PATHS = [
  'M3 11.05L12 3.5L21 11.05V20.1C21 20.6 20.6 21 20.1 21H14.9C14.4 21 14 20.6 14 20.1V14.2H10V20.1C10 20.6 9.6 21 9.1 21H3.9C3.4 21 3 20.6 3 20.1V11.05ZM5.2 12.05V18.8H7.8V12H16.2V18.8H18.8V12.05L12 6.35L5.2 12.05Z',
] as const;
const POS_ICON_PATHS = [
  'M5.3 4H18.7C19.42 4 20 4.58 20 5.3V12.4C20 13.12 19.42 13.7 18.7 13.7H5.3C4.58 13.7 4 13.12 4 12.4V5.3C4 4.58 4.58 4 5.3 4ZM6.2 6.2V11.5H17.8V6.2H6.2ZM5.6 15.1H18.4C19.28 15.1 20 15.82 20 16.7V18.4C20 19.28 19.28 20 18.4 20H5.6C4.72 20 4 19.28 4 18.4V16.7C4 15.82 4.72 15.1 5.6 15.1ZM7 16.75V18.35H9.4V16.75H7ZM10.8 16.75V18.35H13.2V16.75H10.8ZM14.6 16.75V18.35H17V16.75H14.6Z',
] as const;
const SETTINGS_ICON_PATHS = [
  'M10.85 2.5H13.15L13.65 5.05C14.23 5.22 14.79 5.45 15.31 5.74L17.48 4.3L19.1 5.92L17.66 8.09C17.95 8.61 18.18 9.17 18.35 9.75L20.9 10.25V12.55L18.35 13.05C18.18 13.63 17.95 14.19 17.66 14.71L19.1 16.88L17.48 18.5L15.31 17.06C14.79 17.35 14.23 17.58 13.65 17.75L13.15 20.3H10.85L10.35 17.75C9.77 17.58 9.21 17.35 8.69 17.06L6.52 18.5L4.9 16.88L6.34 14.71C6.05 14.19 5.82 13.63 5.65 13.05L3.1 12.55V10.25L5.65 9.75C5.82 9.17 6.05 8.61 6.34 8.09L4.9 5.92L6.52 4.3L8.69 5.74C9.21 5.45 9.77 5.22 10.35 5.05L10.85 2.5ZM12 8.15C10.2 8.15 8.75 9.6 8.75 11.4C8.75 13.2 10.2 14.65 12 14.65C13.8 14.65 15.25 13.2 15.25 11.4C15.25 9.6 13.8 8.15 12 8.15ZM12 10.05C12.75 10.05 13.35 10.65 13.35 11.4C13.35 12.15 12.75 12.75 12 12.75C11.25 12.75 10.65 12.15 10.65 11.4C10.65 10.65 11.25 10.05 12 10.05Z',
] as const;
    ...
    <View
      ...
      {kind === 'ai' ? (
        ...
        <SvgXml
          height="100%"
          width="100%"
          xml={KOLAM_TRANSFER_AM_ICON_SVG}
        />
      ) : kind === 'amWebhook' ? (
        <SvgXml
          height="100%"
        ...
        <Svg height="100%" viewBox="0 0 24 24" width="100%">
          {AUTOMATION_ICON_PATHS.map(path => (
            <Path key={path} d={path} fill="#1a1a1a" fillRule="evenodd" />
          ))}
        </Svg>
      ) : kind === 'brand' ? (
