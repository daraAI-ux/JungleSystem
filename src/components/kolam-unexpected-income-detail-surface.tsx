...
import {
  useKolamUnexpectedIncomeDetailController,
  type KolamUnexpectedIncomeDetailController,
...
export function KolamUnexpectedIncomeDetailSurface({
  onRouteChange,
  route,
}: {
  ...
  const controller = useKolamUnexpectedIncomeDetailController(
    route,
    onRouteChange,
  );
  ...
  return <UnexpectedIncomeDetailBody controller={controller} />;
}

function UnexpectedIncomeDetailBody({
  controller,
}: {
  controller: KolamUnexpectedIncomeDetailController;
}) {
        ...
        <View style={kolamTableToolbarStyles.row}>
          <View style={styles.headerCopy}>
            <Text numberOfLines={2} style={styles.headerTitle}>
              {detail.name || detail.code || 'Pemasukan'}
            </Text>
            <Text numberOfLines={2} style={styles.headerSubtitle}>
              {detail.reason.trim() ||
                'Detail dan informasi pemasukan tak terduga'}
            </Text>
          </View>
