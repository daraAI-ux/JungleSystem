...
export const KOLAM_CHAT_LIVE_EVENT_CONTRACTS: readonly KolamChatLiveEventContract[] =
  [
    ...
    },
    {
      ...
      soundIntent: 'none',
      legacySources: INBOX_LEGACY_SOURCES,
      note: 'Typing state is live UI only and should not refetch messages or drive unread/sound.',
    },
    {
      stream: 'inbox',
      ...
      soundIntent: 'none',
      legacySources: INBOX_LEGACY_SOURCES,
      note: 'DARA progress is handled by thinking UI patches, not a full message refetch.',
    },
    {
      stream: 'inbox',
    ...
    },
    {
      ...
      soundIntent: 'none',
      legacySources: TEAM_CHAT_LEGACY_SOURCES,
      note: 'DARA thinking lifecycle is UI-only. FE does not refetch messages.',
    },
    {
      stream: 'team-chat',
      ...
      soundIntent: 'none',
      legacySources: TEAM_CHAT_LEGACY_SOURCES,
      note: 'Streaming DARA thinking chunk is UI-only. FE does not refetch messages.',
    },
    {
      stream: 'team-chat',
      ...
      soundIntent: 'none',
      legacySources: TEAM_CHAT_LEGACY_SOURCES,
      note: 'End of DARA thinking stream is UI-only. FE waits for the AI message.',
    },
    {
      stream: 'team-chat',
