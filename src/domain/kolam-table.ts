...
const kolamTableColumns: Record<KolamTableId, KolamTableColumn[]> = {
  ...
  production: [
    ...
    { id: 'amount', label: 'Est. Biaya', align: 'right', width: 130 },
    { id: 'notes', label: 'Batch ID', align: 'left', width: 150 },
    { id: 'status', label: 'Status', align: 'left', width: 130 },
    { id: 'products', label: 'Penanggung Jawab', align: 'left', width: 150 },
    { id: 'marketplace', label: 'Tanggal Produksi', align: 'left', width: 130 },
    { id: 'actions', label: '', align: 'right', width: 64 },
  ],
  'production-materials': [
