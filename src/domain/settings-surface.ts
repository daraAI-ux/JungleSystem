...
export const settingsTabItems: SettingsTabItem[] = [
  {
    ...
    route: '/pengaturan',
    description:
      'Versi aplikasi, logo, perusahaan, kontak, alamat, media sosial, akses MAC Kolam, dan staf khusus desktop.',
  ...
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Suara chat, serah tugas DARA, panggilan grup Team Chat, push Firebase, dan SMTP OTP staf.',
    permission: 'websetting:view',
    status: 'source-audit',
    surfaceId: 'web-settings',
    sourceComponent: 'settings/system/page.tsx',
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Asal pengiriman Biteship, kunci browser Google Maps, koordinat asal, dan jam operasional toko.',
    permission: 'websetting:view',
    status: 'source-audit',
    surfaceId: 'web-settings',
    sourceComponent: 'settings/system/page.tsx',
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Pemeliharaan POS/marketplace, Google Sign-In webstore, absensi staf, alur PO, dan livechat.',
    permission: 'websetting:view',
    status: 'source-audit',
    surfaceId: 'web-settings',
    sourceComponent: 'settings/system/page.tsx',
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Metode pembayaran, profil pajak perusahaan, lembur, dan komisi penjualan kandang.',
  ...
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Alat chat AI, alat DARA, balasan otomatis, serah tugas, pengetahuan, dan kontrol SOP.',
  ...
  },
  {
    ...
    route: '/pengaturan',
    description: 'Peran, grup izin, anggota, serta tambah/ubah/hapus peran.',
  ...
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Bagian sitemap dinamis, prioritas, frekuensi perubahan, URL khusus, dan pengecualian.',
    permission: 'websetting:view',
    status: 'source-audit',
    surfaceId: 'web-settings',
    sourceComponent: 'settings/system/page.tsx',
  },
  {
    ...
    route: '/pengaturan',
    description: 'Master data wilayah, tabel region, dan status sinkronisasi.',
    permission: 'websetting:view',
    status: 'source-audit',
    surfaceId: 'web-settings',
    sourceComponent: 'settings/system/page.tsx',
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Landing marketplace, blog, topik blog, hero, banner, CTA, YouTube, pengumuman, dan notifikasi.',
    permission: 'websetting:view',
    status: 'native-summary',
    surfaceId: 'web-settings',
    sourceComponent: 'settings/system/page.tsx',
  },
  {
    ...
    route: '/pengaturan',
    description:
      'Poin tugas, SLA chat, komplain, absensi, level bulanan, dan pratinjau mingguan DARA.',
  ...
  },
  {
    ...
    route: '/pengaturan',
    description: 'Aktif/nonaktif plugin Kolam dan deploy bundle.',
...
export const settingsSurfaceItems: SettingsSurfaceItem[] = [
  {
    ...
    route: '/pengaturan',
    description: 'Tampilan, etalase web, dan konfigurasi umum Kolam.',
    status: 'source-audit',
    badge: 'Konfigurasi',
  },
  {
    ...
    route: '/pengaturan',
    description: 'Akses peran, grup izin, dan tinjauan kemampuan staf.',
    status: 'source-audit',
    badge: 'Akses',
  },
  {
    ...
    title: 'Log Aktivitas',
    route: '/settings/activity-log',
    description: 'Jejak audit untuk aktivitas pengguna, navigasi, dan perubahan API.',
    status: 'native-summary',
    badge: 'Audit',
  },
];
...
export function getSettingsActivityLogDetailFields(
  ...
  const fields: Array<Omit<SettingsActivityLogDetailField, 'sourceComponent'>> =
    [
      ...
      { id: 'user', label: 'Pengguna', value: row.user, mono: false },
      { id: 'source', label: 'Sumber', value: row.source || '-', mono: false },
      { id: 'type', label: 'Tipe', value: row.type, mono: false },
      { id: 'method', label: 'Metode', value: row.method, mono: false },
      ...
      { id: 'duration', label: 'Durasi', value: row.duration, mono: false },
      {
        id: 'action',
        label: 'Aksi',
...
export function getSettingsActivityLogDetailFieldsFromLive(
  ...
  const fields: Array<Omit<SettingsActivityLogDetailField, 'sourceComponent'>> =
    [
      ...
      { id: 'source', label: 'Sumber', value: log.source || '-', mono: false },
      { id: 'type', label: 'Tipe', value: log.type, mono: false },
      { id: 'method', label: 'Metode', value: log.method || '-', mono: false },
  ...
  return [
    {
      ...
      label: 'Jendela',
      value: `${days}d`,
      detail: 'Jendela statistik backend',
      tone: 'muted',
      sourceEndpoint: '/activity-log/stats',
      backendField: 'days',
    },
    {
      ...
      detail: 'Baris sinkronisasi native sebagai pratinjau',
      tone: 'default',
      sourceEndpoint: '/activity-log/stats',
      backendField: 'byType',
    },
    {
      ...
      detail: 'Dipetakan ke backend byStatus',
      tone: 'success',
      sourceEndpoint: '/activity-log/stats',
    ...
    },
    {
      ...
      detail: 'Peringatan sampai detail API lengkap',
...
export function getSettingsActivityLogStatsCardsFromLive(
  ...
  return [
    ...
    },
    {
      ...
      detail: `${apiCount} API / ${pageCount} halaman`,
      tone: 'default',
      sourceEndpoint: '/activity-log/stats',
      backendField: 'byType',
    },
    {
      ...
      label: 'Berhasil',
      value: successCount.toString(),
      detail: 'Backend byStatus berhasil',
      tone: 'success',
      sourceEndpoint: '/activity-log/stats',
      backendField: 'byStatus',
    },
    {
      ...
      detail: 'Request gagal dalam jendela statistik',
...
export function getSettingsActivityLogFilterControls(): SettingsActivityLogFilterControl[] {
  return [
    ...
    },
    {
      ...
      options: [
        { id: '', label: 'Semua (termasuk mencurigakan)' },
        { id: 'true', label: 'Hanya mencurigakan' },
        { id: 'automation_tool_ua', label: 'UA: alat otomasi' },
        { id: 'missing_user_agent', label: 'UA: kosong' },
        { id: 'forged_source_no_origin', label: 'Sumber palsu (tanpa origin)' },
        { id: 'source_origin_mismatch', label: 'Sumber/origin tidak cocok' },
      ],
      sourceComponent: 'settings/activity-log/activity-log-list.tsx',
    },
  ];
...
export function getSettingsRoleInfoPanel(
  ...
  return {
    ...
    deleteLabel: 'Hapus',
    notice: fullAccess
      ? 'Super Admin memiliki akses penuh ke semua resource. Izin tidak dapat diubah.'
      : undefined,
    sourceComponent: 'settings/roles/list.tsx',
  };
}
...
function getPermissionActionLabel(action: string) {
  const labels: Record<string, string> = {
    ...
    check: 'Pemeriksaan kualitas',
    complete_stock: 'Masuk stok',
    view_by_admin: 'Lihat Admin',
    update_by_admin: 'Ubah Admin',
    create_by_admin: 'Tambah Admin',
    delete_by_admin: 'Hapus Admin',
    change_role_by_admin: 'Ubah Peran',
    opname: 'Opname',
    approve: 'Setujui',
    reject: 'Tolak',
    confirm: 'Konfirmasi',
    ...
    view_salary: 'Lihat Gaji',
    view_all: 'Lihat Semua',
    flag_employee: 'Tandai Karyawan',
    verify: 'Verifikasi',
    update_decision: 'Keputusan',
    assign_staff: 'Tugaskan',
    update_return: 'Retur',
    close: 'Close',
    '*': 'All',
  };
  ...
  return roles.map(role => {
    ...
    return {
      ...
      meta:
        ...
        `${getSettingsRolePermissionCount(role)} izin live`,
...
export function getSettingsRoleResourceLabel(resource: string) {
  const labels: Record<string, string> = {
    ...
    websetting: 'Pengaturan Web',
    'blog-topic': 'Topik Blog',
    'iucn-status': 'Status IUCN',
    'ai-seo': 'DARA AI SEO',
    'ai-market-intel': 'Intel Pasar DARA',
    'dara-training': 'Pelatihan DARA',
    'task-manager': 'Manajer Tugas (plugin)',
    ...
    chat: 'Chat / Kotak Masuk',
    payroll: 'Penggajian',
    salary: 'Gaji & Bonus',
    staff_attendance: 'Absensi Staf',
    kasbon: 'Kasbon',
    salary_deduction: 'Potongan Gaji',
    'customer-species': 'Spesies Pelanggan (portal)',
